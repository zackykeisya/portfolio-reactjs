...
const Footer = () => {
  const socialLinks = [
    {
      name: 'Instagram',
      url: 'https://www.instagram.com/zackykeisya/',
      icon: (
    ...
    {
      name: 'LinkedIn',
      url: 'https://www.linkedin.com/in/zackykeisyaakbar/',
      icon: (
        <svg role="img" width="20" className="fill-current" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    ...
    {
      name: 'GitHub',
      url: 'https://github.com/zackykeisya',
      icon: (
        <svg role="img" width="20" className="fill-current" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="w-full pt-10 border-t border-slate-400">
          <div className="flex items-center justify-center mb-2">
            {socialLinks.map((social, index) => (
              <a
                ...
                className="w-9 h-9 flex justify-center items-center border border-slate-300 mr-3 rounded-full hover:border-primary hover:bg-primary hover:text-white transition duration-300"
              >
                {social.icon}
              </a>
            ))}
          ...
          <p className="font-medium text-sm text-slate-200 text-center">
            ...
            <a 
              target="_blank" 
              rel="noopener noreferrer"
              href="https://www.linkedin.com/in/zackykeisyaakbar/" 
              className="font-bold text-white hover:text-primary transition duration-300"
            >
              Zacky Keisya Akbar 
            </a>
          </p>
