              ...
              <div className="flex items-center space-x-3">
                {socialLinks.map((social, index) => (
                  <a
                    ...
                    className="social-icon w-12 h-12 flex justify-center items-center border border-slate-300 rounded-full hover:border-primary hover:bg-primary hover:text-white transition-all duration-300"
                    title={social.name}
                  >
                    {social.icon}
                  </a>
